...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role", sa.Enum("ADMIN", "CUSTOMER", name="user_role"), nullable=False
        ),
        sa.Column("is_active", sa.Boolean(), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index(
        op.f("ix_rental_requests_request_number"),
        "rental_requests",
        ["request_number"],
        unique=True,
    )
    op.create_index(
        op.f("ix_rental_requests_user_id"), "rental_requests", ["user_id"], unique=False
    )
    op.create_table(
        "store_settings",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "payment_method",
            sa.Enum("BANK_TRANSFER", "VIETQR", "CARD", "COD", name="payment_method"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_rental_request_items_product_id"),
        "rental_request_items",
        ["product_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rental_request_items_rental_request_id"),
        "rental_request_items",
        ["rental_request_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_rental_request_items_rental_request_id"),
        table_name="rental_request_items",
    )
    op.drop_index(
        op.f("ix_rental_request_items_product_id"), table_name="rental_request_items"
    )
    ...
    op.drop_index(
        op.f("ix_rental_requests_request_number"), table_name="rental_requests"
    )
