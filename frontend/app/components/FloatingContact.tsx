...
export default function FloatingContact({
  config = DEFAULT_HOME_DATA.floating_contacts,
  forceShow = false,
  ...
  const phoneHref = `tel:${config.hotline || "0706067799"}`;
  const phoneDisplay = config.hotline_display || config.hotline || "0706.067.799";
  const zaloUrl = config.zalo_link || "https://zalo.me/0706067799";
  const facebookUrl = config.messenger_link || "https://www.facebook.com/vanbassmusiccenterdanangvietnam?locale=vi_VN";
